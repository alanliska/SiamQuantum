...
public class MolCanvas_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSiamQuantum = (Button) findViewById(R.id.toSiamQuantum);
        toSiamQuantum.setOnClickListener(toSiamQuantumClick);
...
//                .setView(scrollview)
    ...
    private View.OnClickListener toSiamQuantumClick; {
        toSiamQuantumClick = new View.OnClickListener() {
            public void onClick(View v) {
