...
public class ManualSiamquantum extends MainActivity {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualsiamquantum);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/siamquantum_manual.pdf")); //Normal File loaction
