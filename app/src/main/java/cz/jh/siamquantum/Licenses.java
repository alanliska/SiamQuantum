...
import cz.jh.siamquantum.MainActivity;
...
public class Licenses extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        license_siamquantum = (Button) findViewById(R.id.license_siamquantum);
        license_siamquantum.setOnClickListener(license_siamquantumClick);
    ...
    private View.OnClickListener license_siamquantumClick; {
        license_siamquantumClick = new View.OnClickListener() {
            public void onClick(View v) {
    ...
    public void alertsiamquantum() {
        new AlertDialog.Builder(Licenses.this)
                .setTitle("LICENSE-SIAMQUANTUM")
                .setMessage(exec("cat "+getFilesDir()+"/licenses/LICENSE-SIAMQUANTUM.txt"))
