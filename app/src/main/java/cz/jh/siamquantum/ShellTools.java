...
import static cz.jh.siamquantum.Spannables.colorized_x11basic;
    ...
    private View.OnClickListener ShellButtonClick; {
        ...
        ShellButtonClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Arguments = Arguments.replace(" siamquantum ", " "+getApplicationInfo().nativeLibraryDir+"/libsiamquantum.so ");
